...
@section('content')
    @if(!empty($user))
        <div id="main_info">
            <?php  $badges = \App\Badge::all();$m_badges = \App\MasterBadge::all();?>
            <?php
                            ...
                            <div class="row justify-content-center">
                                <div class="col-8">
                                    <div class="row align-items-center justify-content-center badge-min-height">
                                        ...
                                        @else
                                            <h4 class="mt-0" style="color: #bdb7b7;font-size: 20px;">No badges</h4>
                                        @endif
                                    </div>
                                </div>
                            </div>
    ...
    @else
        <img src="{{asset("uploads/notfound.jpg")}}" width="100%" alt="">
    @endif
@endsection
@section('models')
    @if(!empty($user))
