            ...
            <div class="col-md-3 main_info_cover text-center">
              <a href="#">
                <figure class="figure">
                  ...
                  @else
                    <img src="{{ asset('uploads/user-pic/headshot_full.png') }}" class="figure-img img-fluid" alt="cover">
                  @endif
                </figure>
              </a>
            </div>
            <div class="col-md-5 basic_info_block">
              <h2>{{$user->name}} <img src="{{ asset('new-theme/images/verified_user.png') }}" alt="verified" /></h2>
              <p><i class="fa fa-map-marker-alt"></i> &nbsp;Naples, Italy</p>
