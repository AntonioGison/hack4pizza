            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="col-sm-12" style="background-color: white">
                        {{ Form::model($badge, ['method' => 'PATCH','route' => ['badges.update', $badge->id],'class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']) }}
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group {{ $errors->has('pic') ? 'has-error' : '' }}">
                                ...
                                @if(File::exists('uploads/badges/'.$badge->pic))
                                    <img src="{{asset('uploads/badges/'.$badge->pic)}}"
