...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading" style="text-transform: capitalize">Manage {{Request::segment(2)}} <button class="btn btn-danger pull-right" onclick="del_selected()">Delete All</button> <a href="{{route('badges.create')}}" class="btn btn-info pull-right" style="margin-right: 10px">Add New</a></div>
                    <div class="col-sm-12" style="background-color: white">
                        <div class="table-responsive">
                            <form action="{{url('admin/delete-selected-badges')}}" method="post" id="uform">
...
@section('scripts')
            ...
            swal({
                ...
                function(){
                    var APP_URL = {!! json_encode(url('/')) !!}
                        ...
                        window.location.href = APP_URL+"/admin/badges/delete/"+id;
                });
    ...
    <script>
        ...
        var copoun = $('#badge').DataTable( {
            ...
            "responsive": true,
            "ajax": {
                "url":"{{ route('admin-getAddedBadges') }}",
                "dataType":"json",
                "type":"POST",
        ...
        function view(id) {
            ...
            $.post("{{ route('admin-getBadges') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
