            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="col-sm-12" style="background-color: white">
                        {{ Form::model($badge, ['method' => 'PATCH','route' => ['master-badges.update', $badge->id],'class'=>'form-horizontal','role'=>'form','enctype'=>'multipart/form-data']) }}
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group {{ $errors->has('badge') ? 'has-error' : '' }}">
                                {!! Form::label('Select badge:') !!}
                                {{  Form::select('badge', $bages,$badge->id, ['class' => 'form-control'])  }}
                                <span class="text-danger">{{ $errors->first('badge') }}</span>
                            </div>
                        </div>
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group {{ $errors->has('number') ? 'has-error' : '' }}">
                                {!! Form::label('Number Obtain:') !!}
                                {{ Form::number('number', null, ['class' => 'form-control ','id'=>'category']) }}
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div class="form-group {{ $errors->has('pic') ? 'has-error' : '' }}">
                                ...
                                @if(File::exists('uploads/master-badges/'.$badge->pic))
                                    <img src="{{asset('uploads/master-badges/'.$badge->pic)}}"
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-xs-12 text-center">
                                <a class="btn btn-danger btn-sm" href="{{ route('master-badges.index') }}">
